...
//设置json出错信息
void CJsonObject::JSONSetErrInfo( base_tools::CErrorInfoParser &cErrParse )
{
	cErrParse.SetModType(base_tools::CErrorInfoParser::JSON_MOD);
	cErrParse.SetCode(base_tools::CErrorInfoParser::JSON_PARSE_ERR);
	cErrParse.SetMess(m_strErrMsg);
}
